...
rmd_group_buttons(
  ...
  arrange_button("Sort by expectancy", "lifeExp", numeric = TRUE, icon = icon("sort-numeric-asc")),
  arrange_button("Sort by expectancy (decreasing)", "lifeExp", numeric = TRUE, desc = TRUE, icon = icon("sort-numeric-desc")),
